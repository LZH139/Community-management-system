...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link smooth-link" href="#features">展示</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link smooth-link" href="#contact">联系我们</a>
                    </li>
                </ul>
                <form class="form-inline">
                    <a href="/login.jsp" class="btn align-middle btn-primary">登陆</a>
                </form>
            </div>
        </div>
    </nav>
            ...
            <div class="section-body">
                <div class="row col-spacing">
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img01.jpg" alt="Article Image">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img04.jpg" alt="Article Image">
                            <div class="card-body">
                                <div class="card-subtitle mb-2 text-muted">by <a href="#">John Doe</a> on August 10, 2017</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img02.jpg" alt="Article Image">
                            <div class="card-body">
                                <div class="card-subtitle mb-2 text-muted">by <a href="#">John Doe</a> on August 10, 2017</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img05.jpg" alt="Article Image">
                            <div class="card-body">
                                <div class="card-subtitle mb-2 text-muted">by <a href="#">John Doe</a> on August 10, 2017</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img03.jpg" alt="Article Image">
                            <div class="card-body">
                                <div class="card-subtitle mb-2 text-muted">by <a href="#">John Doe</a> on August 10, 2017</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <article class="card">
                            <img class="card-img-top" src="dist/img/news/img06.jpg" alt="Article Image">
                            <div class="card-body">
                                <div class="card-subtitle mb-2 text-muted">by <a href="#">John Doe</a> on August 10, 2017</div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <figure class="projects-picture">
                        <img src="dist/img/youzhang.png" alt="Youzhang">
                    </figure>
                </div>
                <div class="col-12 col-md-6">
    ...
    <script src="dist/js/jquery.easeScroll.js"></script>
